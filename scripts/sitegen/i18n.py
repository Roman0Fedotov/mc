TRANSLATIONS = {
    "ru": {
        ...
        "acquisition_notes": "Сведения о приобретении",
        "folios": "Количество листов",
        "dimensions": "Размер",
        "script": "Письмо",
        "vocalization": "Вокализация",
        "provenance": "Провенанс",
        "client_owner": "Заказчик / владелец",
        "colophon": "Колофон",
        "publication": "Публикация",
        "online_catalogue": "Онлайн-каталог",
        "digital_copy": "Цифровая копия",
        "notes": "Примечания",
    ...
    "en": {
        ...
        "online_catalogue": "Online catalogue",
